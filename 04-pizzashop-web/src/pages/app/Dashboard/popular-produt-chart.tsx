...
export function PopularProdutChart(){
                                ...
                                <Pie
                                    ...
                                    label={({
                                        ...
                                        return (
                                            ...
                                            >
                                                {productsPopular[index].product.length > 12
                                                    ? productsPopular[index].product.substring(0, 12).concat('...')
                                                    : productsPopular[index].product}{' '}
                                                ({value})
                                            </text>
                                        )
                                    }}
                                >
                                    {productsPopular.map((_, index) => (
