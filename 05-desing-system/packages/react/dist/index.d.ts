...
declare const AvatarImage: _stitches_react_types_styled_component.StyledComponent<any, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        gray100: string;
...
declare function Avatar(props: AvatarProps): any;

export { Avatar, Box, type BoxProps, Heading, type HeadingProps, Text, type TextProps };
